...
<form>
原来的 AV/BV 链接 <input type="text" name="AV/BV"value=<?php echo $_POST["av_bv"]; ?>>
<?php
  ...
  if ( $_POST["av_bv"][31] == "B" )  
  {
    $argus = substr($_POST["av_bv"],31,12);
    $result_av_bv = "av".dec($argus);
    // echo $result_av_bv;
  }

  else if ( $_POST["av_bv"][31] == "a" )
  {
    $argus = substr($_POST["av_bv"],33);
    $argus = substr($argus,0,strlen($argus)-1);
    $result_av_bv = enc($argus);
    // echo $result_av_bv;
  }

?> 
转换得到的 AV/BV 链接 <input type="text" id="copy1" name="result_av_bv" value=<?php echo $url.$result_av_bv; ?>>
